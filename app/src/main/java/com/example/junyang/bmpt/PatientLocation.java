...
public class PatientLocation extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // String key3 = intent.getStringExtra("key3");
        ...
        String id = intent.getExtras().getString("key1");
        String location = intent.getExtras().getString("key2");
        String ward = intent.getExtras().getString("key3");
        TextView textView = (TextView) findViewById(R.id.txt_name);
        textView.setText(name);
        TextView textView1 = (TextView) findViewById(R.id.txt_id);
        textView1.setText(id);
        TextView textView2 = (TextView) findViewById(R.id.txt_location);
        textView2.setText(location);
        TextView textView3 = (TextView) findViewById(R.id.txt_ward);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.patient_location, menu);
        return true;
    }
